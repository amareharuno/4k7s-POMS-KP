...
public class Util {
    ...
    //quickblox ID
    public static final String QB_APPID = "57630";
    public static final String QB_AUTH_KEY = "SMJ7gBRQZyezpn3";
    public static final String QB_AUTH_SECRET = "HDp8gKGQSrG5r9q";
    public static final String QB_ACCOUNT_KEY = "P3ncWadiQSdtL65tq8qL";
    ...
    public static final String IMOJI_SDK_API_TOKEN = "dc6zaTOxFJmz";
